...
#define CLK_ICKR *(volatile unsigned char*)(CLK_BaseAddress + 0x00)
#define CLK_SWR *(volatile unsigned char*)(CLK_BaseAddress + 0x04)
#define CLK_SWCR *(volatile unsigned char*)(CLK_BaseAddress + 0x05)
...
//Registers
#define AWU_CSR  *(volatile unsigned char *)(AWU_BaseAddress + 0x00)
#define AWU_CSR_MSR   0x01
#define AWU_CSR_AWUEN 0x10
#define AWU_APR  *(volatile unsigned char *)(AWU_BaseAddress + 0x01)
#define AWU_TBR  *(volatile unsigned char *)(AWU_BaseAddress + 0x02)
